define([
    ...
    return Elf.Component("calendar", Elf.redactElement(template, slider, format))(
        ...
        Elf.createClass({
            ...
            get prevMonth () {
                return !(this.nowMonth <= this.minMonth) ?
                       !(this.nowMonth >= this.maxMonth) ? plusMonth(this.nowMonth, -1) : plusMonth(this.nowMonth, -2) : this.nowMonth;
            },
            ...
            get through () {
                return this.minMonth <= this.maxMonth ? (this.maxMonth.getFullYear() * 12 + this.maxMonth.getMonth()) -
                                                        (this.minMonth.getFullYear() * 12 + this.minMonth.getMonth()) + 1 : 3;
            },
